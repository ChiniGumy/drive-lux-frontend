function AboutUs() {
  return (
    <div className="bg-[#111] p-24 w-full flex flex-col items-center">
        ...
        <div className="w-full flex justify-between h-[400px]">
            ...
            <div className="flex flex-col w-[45%]">
                <h1 className="text-4xl font-bold text-[#3092BB]">QUIENES SOMOS</h1>
                <p className="text-2xl leading-[41px] w-[50ch] text-[#D4D5D7] my-4 ">Bienvenidos a Drive-Lux, la plataforma líder en alquiler de vehículos de lujo. Nuestra misión es ofrecer una experiencia incomparable a aquellos que desean el placer de conducir con estilo y exclusividad. En Drive-Lux, entendemos que el lujo no es solo una opción, es una necesidad.</p>
            </div>
        </div>

        <div className="w-full flex justify-between h-[450px] mt-24">
            <div className="flex flex-col items-end w-[45%]">
                <h1 className="text-end text-4xl font-bold text-[#3092BB]">DESDE NUESTROS <br/> INICIOS EN 2021</h1>
                <p className="text-end text-2xl leading-[41px] w-[50ch] text-[#D4D5D7] my-4 ">Hemos dedicado cada momento a curar una flota impresionante de vehículos de alta gama, seleccionando meticulosamente cada modelo por su rendimiento, diseño y capacidad de ofrecer una experiencia única en su clase. Nuestros clientes regresan porque saben que en Drive-Lux, la calidad y el servicio excepcional son la norma.</p>
            </div>
